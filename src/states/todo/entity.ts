...
import { stateTodoDescription, stateTodoIsDone, stateTodoTitle } from 'states/todo/valueObject';
...
export const stateTodo = selectorFamily<Todo, TodoId>({
  ...
  set:
    ...
    ({ get, set, reset }, newValue) => {
      ...
      newValue.description && set(stateTodoDescription(todoId), newValue.description);
